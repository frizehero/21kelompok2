      ...
      <div class="col-md-2" style="padding: 0px">
        <div id="demo-dp-txtinput">
          <?php if($this->uri->segment(2) != 'cari'){?>
            <input type="text" autocomplete="off" name="cari" class="form-control input-sm " placeholder="pengumuman">
          <?php } ?>
          <?php if($this->uri->segment(2) == 'cari'){
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="panel-body">
              ...
              <div class="col-md-6">
                <label for="" class="control-label">Nama pengumuman</label>
                <input type="text" name="nama_pengumuman" placeholder="Nama pengumuman" class="form-control" value="<?= $res->nama_pengumuman ?>">
              </div>
              <div class="col-md-6" style="margin-top: 2%">
                <label for="" class="control-label">judul</label>
                <textarea type="text" name="keterangan" rows="5" placeholder="Keterangan" class="form-control"><?= $res->judul ?></textarea>
              </div>
              <div class="col-md-6" style="margin-top: 2%">
                <label for="" class="control-label">tanggal</label>
                <textarea type="date" name="tanggal" rows="5" placeholder="tanggal" class="form-control"><?= $res->tanggal ?></textarea>
              </div>
              <div class="col-md-6 " style="margin-top: 2%">
          ...
          <div class="modal-body">
            ...
            <div class="panel-body">
              ...
              <div class="col-md-8">
                ...
                <input type="text" disabled="disabled" name="nama_pengumuman" placeholder="Nama pengumuman" class="form-control" value="<?= $res->nama_pengumuman ?>">
              </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>Anda Yakin Ingin Menghapus <b><?php echo $res->nama_pengumuman ?></b> ? </p>
          <br>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="panel-body">
          ...
          <div class="col-md-6">
            <label for="" class="control-label">Tanggal</label>
            <input type="text" name="id_pengumuman" placeholder="Tanggal" class="form-control">
          </div>
          <div class="col-md-6" >
            <label for="" class="control-label">Judul</label>
            <input type="file" name="gambar" placeholder="Logo pengumuman" class="form-control" id="userfile" onchange="tampilkanPreview(this,'preview')">
          </div>
          <div class="col-md-6" style="margin-top: 2%">
            <label for="" class="control-label">isi pengumuman</label>
