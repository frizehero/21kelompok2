...
<div class="col-lg-12">
	<div class="panel">
		<div class="panel-heading">
			<h3 class="panel-title">Edit Dudi</h3>
		</div>
		...
		<div class="panel-body"><div class="form-group">
			...
			<div  class="col-sm-3"><div class="select">
				<label>Jurusan</label>
				<br>
				<select name="jurusan_dudi" style="height: 48px">
					<option value="<?php echo $tampil['id_jurusan']?>">Pilih jurusan</option>
					<?php foreach ($tampil_jurusan as $pp ) {?>
					<option value="<?php echo $pp->id_jurusan?>"><?php echo $pp->nama?></option>
				<?php } ?>
			...
			<div style="margin-top: 20px" class="col-md-6">
				<label>Alamat</label>
				<textarea class="form-control" id="inputCity"  name="alamat_dudi" style="height: 100px; width:100%;"><?php echo $tampil['alamat_dudi']?></textarea>
