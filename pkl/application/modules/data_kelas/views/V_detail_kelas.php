  ...
  <?php foreach($tampil_data as $res) {
    ...
    <div class="col-md-3">
      ...
      <div class="panel widget">
          ...
          <div class="widget-control">
           <div class="btn-group dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right" style="">
              <li><a href="<?php echo base_url('data_kelas/edit_siswaa/')?>?id=<?php echo $res->id_siswa?>"><i ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
        ...
        <?php
        $id= $tampil_detail['id_kelas'];
        $qq= $this->m_data_kelas->tampil_data($id);
        ?>
